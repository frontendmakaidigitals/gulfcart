...
export default function Hero() {
  return (
    <section className="relative overflow-hidden px-[26px] pt-10 pb-[70px]">
          ...
          <div className="mt-7 grid max-w-[580px] grid-cols-1 gap-x-6 gap-y-[13px] sm:grid-cols-2">
            {heroBullets.map((b) => (
              <div key={b} className="flex items-start gap-[11px]">
                <span className="mt-0.5 flex size-[19px] shrink-0 items-center justify-center rounded-md border border-accent/40 bg-accent/15 text-[11px] font-extrabold text-accent"><CheckIcon /></span>
